      ...
      <div className='flex flex-col md:flex-row gap-10 px-5 md:px-10 py-8 md:py-10'>
        ...
        <div className='md:w-[55%] md:order-3 order-2'>
          ...
          <div className='flex gap-2 p-1 relative items-center border-2'>
            ...
            <div className='w-[55%] sm-[70%] md:w-[75%]'>
              <p>Title</p>
              <p><span>tags</span> <span>open/closed</span></p>
            </div>
            <p className='absolute right-2'><span>10</span> <i class="fa-regular fa-comment mr-2"></i> <span>12</span> <i class="fa-regular fa-thumbs-up"></i></p>
          </div>
        </div>
